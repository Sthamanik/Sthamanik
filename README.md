...
### [Forge - Distributed Backend Infrastructure](https://github.com/Sthamanik/Forge)
Production-style distributed backend platform built in Go  
**Tech:** Go, PostgreSQL, Redis, Docker, Prometheus  
**Features:** API Gateway, JWT + RBAC, Worker Pool, Cache-aside, Observability  
**Load Test:** ~2000 req/sec at 35ms p95 latency  
_✅ Complete_
...
- Translating **real-world problems into system architectures**
- Clean code, clear abstractions, and well-defined responsibilities
